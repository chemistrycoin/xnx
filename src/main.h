...
static const int64 MAX_MONEY = 42000000 * COIN; // Xanax: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 2) / 250; // Xanax: Priority cutoff is 2 Xanax day / 250 bytes.
    }
